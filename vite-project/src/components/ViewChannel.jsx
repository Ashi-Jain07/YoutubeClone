...
function ViewChannel() {
    ...
    //Fetch channels
    const { data, error, loading } = useFetch("http://localhost:5500/channels", {
        method: "GET"
    });
    ...
    async function handleAddVideo(e, id) {
        ...
        try {
            const response = await fetch(`http://localhost:5500/addVideo/${id}`, {
                method: "PATCH",
                headers: {
    ...
    async function handleEditVideo(id, index) {
        const token = Token.token;
        try {
            const response = await fetch(`http://localhost:5500/editvideo/${id}`, {
                method: "PATCH",
                headers: {
                    "Accept": "application/json",
                    "Content-Type": "application/json",
    ...
    async function handleDeleteVideo(id, index) {
        const token = Token.token
        try {
            const response = await fetch(`http://localhost:5500/deleteVideo/${id}`, {
                method: "DELETE",
                headers: {
                    "Accept": "application/json",
                    "Content-Type": "application/json",
